...
echo "=== [1/4] Updating src/math.rs to include both CudaMathEngine and BatchedProjectiveArithmetic ==="
...
git add src/math.rs
git commit -m "fix: re-introduce CudaMathEngine alongside BatchedProjectiveArithmetic in src/math.rs"

echo "=== [4/4] Pushing to Remote Repository ==="
git push origin main

echo "=== Success! Build fixed, tested, committed, and pushed. ==="
